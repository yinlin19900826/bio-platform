...
import com.biocome.platform.admin.mapper.EstateMapper;
...
public class SynchoBiz {
     ...
     *
     * @param vo 参数
     * @return com.biocome.platform.common.msg.ObjectRestResponse<java.util.List < com.biocome.platform.admin.vo.EstateResp>>
     * @Author shenlele
     ...
     *
     * @param vo 参数
     * @return com.biocome.platform.common.msg.ObjectRestResponse<java.util.List < com.biocome.platform.admin.vo.BuildResp>>
     * @Author shenlele
     * @Date 2019/5/21 19:36
     */
     ...
     *
     * @param vo 参数
     * @return com.biocome.platform.common.msg.ObjectRestResponse<java.util.List < com.biocome.platform.admin.vo.UserResp>>
     * @Author shenlele
     * @Date 2019/5/21 19:36
     */
     ...
     *
     * @param vo 参数
     * @return com.biocome.platform.common.msg.ObjectRestResponse<com.biocome.platform.common.msg.auth.BaseRpcResponse>
     * @Author shenlele
